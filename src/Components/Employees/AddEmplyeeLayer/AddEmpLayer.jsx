...
function AddEmpLayer({ setShowAddEmp, showAddEmp, openAlert ,setTrickReload }) {
                ...
                <div className='row h-75'>
                    <div className="col-lg-8 col-11 p-md-4 p-2 m-auto rounded-1 bg-light ">
                        <form>
                            ...
                            <button type='button' onClick={addEmployee} className='btn btn-success m-2'>Add Employee</button>
